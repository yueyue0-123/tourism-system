      ...
      <header class="header">
        <div class="nav-container">
          <div class="logo-container">
            ...
            <h1 class="logo-text">Туристическая информационная система</h1>
          </div>
          ...
          <div class="user-actions">
            <template v-if="isLoggedIn">
              <el-dropdown trigger="click" @command="handleCommand">
                ...
                <template #dropdown>
                  <el-dropdown-menu>
                    <el-dropdown-item command="profile" icon="User">Личный кабинет</el-dropdown-item>
                    <el-dropdown-item command="guide" icon="Notebook">Мои путеводители</el-dropdown-item>
                    <el-dropdown-item command="collection" icon="Star">Моё избранное</el-dropdown-item>
                    <el-dropdown-item command="orders" icon="Ticket">Мои заказы</el-dropdown-item>
