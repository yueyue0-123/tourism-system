<template>
  <div class="guide-edit-container">
    <div class="page-header">
      <h1>{{ form.id ? 'Редактировать' : 'Создать путеводитель' }}</h1>
      <p>Поделитесь опытом, чтобы помочь другим открыть мир</p>
    </div>
    ...
    <div class="edit-form-container">
      <el-form 
        ...
        class="edit-form"
      >
        <el-form-item label="Заголовок" prop="title" required>
          <el-input 
            v-model="form.title" 
            placeholder="Введите заголовок (до 30 символов)" 
            maxlength="50"
            show-word-limit
          />
        </el-form-item>
        
        <el-form-item label="Обложка" prop="coverImage" required>
          <div class="cover-uploader-container">
            ...
            >
              ...
              <div v-else class="upload-placeholder">
                ...
                <div class="upload-tip">Рекомендуемый размер: 900×600px, JPG/PNG</div>
              </div>
            </el-upload>
            <div class="form-tips" v-if="!form.coverImage">
              Добавьте красивую обложку, чтобы привлечь больше читателей
            </div>
          </div>
        </el-form-item>
        
        <el-form-item label="Содержание" prop="content" required>
          <div class="editor-container">
            <WangEditor v-model="form.content" />
            <div class="form-tips">
              Поддерживает текст, изображения, видео и мультимедиа
            </div>
          </div>
        </el-form-item>
        ...
        <el-form-item>
          <div class="form-actions">
            ...
            <el-button type="primary" @click="submit" :loading="submitting">
              {{ form.id ? 'Сохранить' : 'Опубликовать' }}
            </el-button>
          </div>
        </el-form-item>
      </el-form>
