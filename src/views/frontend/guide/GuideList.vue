        ...
        <div class="page-header">
          <div class="header-content">
            ...
            <p class="page-subtitle">
              Исследуйте удивительные заметки и полезные советы путешественников
            </p>
          </div>
      ...
      <div class="section-container">
        <div class="guides-container" v-loading="loading">
          <div class="empty-state" v-if="tableData.length === 0 && !loading">
            ...
            <h3 class="empty-title">Путеводителей пока нет</h3>
            <p class="empty-desc">Станьте первым, кто поделится путеводителем!</p>
