      ...
      <template #header>
        <div class="welcome-header">
          ...
          <div class="welcome-info">
            ...
            <p class="welcome-subtitle">Начните отличное управление путешествиями</p>
          </div>
        </div>
      </template>
      <div class="role-info">
        ...
        <el-col :span="6">
          <el-card class="action-card scenic-card" @click="navigateTo('/back/scenic')">
            <div class="action-content">
              ...
              <p>Управление информацией о местах</p>
            </div>
          </el-card>
        </el-col>
        <el-col :span="6">
          <el-card class="action-card accommodation-card" @click="navigateTo('/back/accommodation')">
            <div class="action-content">
              ...
              <h3>Проживание</h3>
              <p>Управление информацией о жилье</p>
            </div>
          </el-card>
        </el-col>
        <el-col :span="6">
