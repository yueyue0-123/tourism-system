    ...
    <el-card class="search-card" shadow="never">
      <el-form :inline="true" :model="searchForm" class="search-form">
        <el-form-item label="Номер заказа">
          <el-input v-model="searchForm.orderNo" placeholder="Введите номер заказа" clearable></el-input>
        </el-form-item>
        <el-form-item label="Имя посетителя">
          <el-input v-model="searchForm.visitorName" placeholder="Введите имя посетителя" clearable></el-input>
        </el-form-item>
        <el-form-item label="Телефон">
          <el-input v-model="searchForm.visitorPhone" placeholder="Введите номер телефона" clearable></el-input>
        </el-form-item>
