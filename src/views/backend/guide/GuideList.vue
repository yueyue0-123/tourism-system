<template>
  <div class="guide-back-list">
    <div class="page-header">
      <h1 class="page-title">Управление путеводителями</h1>
      ...
      <el-card shadow="never" class="search-card">
        <el-form :inline="true" :model="searchForm" class="search-form">
          <el-form-item label="Заголовок">
            <el-input v-model="searchForm.title" placeholder="Заголовок путеводителя" clearable @keyup.enter="handleSearch" />
          </el-form-item>
          <el-form-item>
            <el-button type="primary" @click="handleSearch" :icon="Search" class="search-btn">Поиск</el-button>
            <el-button @click="resetSearch" :icon="Refresh" class="reset-btn">Сброс</el-button>
            <el-button type="success" @click="handleCreate" :icon="Plus" class="add-btn">Создать</el-button>
          </el-form-item>
        </el-form>
      </el-card>
    </div>
